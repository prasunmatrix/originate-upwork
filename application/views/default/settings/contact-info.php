		...
		<div class="dashboard-content-inner">
            ...
            <div class="dashboard-box margin-top-0">
                    ...
                    <div class="headline d-flex">
                        <h4><i class="icon-material-outline-account-circle"></i> <?php echo __('setting_contact_account','Account');?> </h4>  
            ...
            <div class="dashboard-box ">
                    ...
                    <!-- Headline -->
                    <div class="headline d-flex">
                        <h4><i class="icon-feather-map-pin"></i> <?php echo __('setting_contact_location','Location');?></h4>
