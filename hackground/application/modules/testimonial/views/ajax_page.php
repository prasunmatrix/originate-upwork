...
<div class="modal-body">
  <form role="form" id="add_form" action="<?php echo $form_action;?>" onsubmit="submitForm(this, event)">
    ...
    <div class="form-group">
      <label for="company_name_<?php echo $v;?>">Company Name (<?php echo $v;?>)</label>
      <input type="text" class="form-control reset_field" id="company_name_<?php echo $v;?>" name="lang[company_name][<?php echo $v; ?>]" autocomplete="off">
    </div>
    <div class="form-group">
...
<div class="modal-body">
  <form role="form" id="add_form" action="<?php echo $form_action;?>" onsubmit="submitForm(this, event)">
    ...
    <div class="form-group">
      <label for="company_name_<?php echo $v;?>">Company Name (<?php echo $v;?>)</label>
      <input type="text" class="form-control reset_field" id="company_name_<?php echo $v;?>" name="lang[company_name][<?php echo $v; ?>]" autocomplete="off" value="<?php echo !empty($detail['lang']['company_name'][$v]) ? $detail['lang']['company_name'][$v] : '';?>">
    </div>
    <div class="form-group">
      <label for="description_<?php echo $v;?>">Description (<?php echo $v;?>)</label>
    ...
    <div class="form-group">
      ...
      <div class="image-wrapper" id="previous_logo">
        <button type="button" class="close" onclick="removeByID('previous_logo')"><i class="icon-feather-trash"></i></button>
        <img src="<?php echo UPLOAD_HTTP_PATH.'testimonial-icon/'.$detail['logo']; ?>" alt="" />
        <input type="hidden" name="logo" value="<?php echo $detail['logo'];?>"/>
      </div>
    </div>
    <?php } ?>
    <?php $this->load->view('upload_file_component', array('input_name' => 'logo', 'label' => 'Thumb Image',  'url' => base_url('testimonial/upload_file'))); ?>
    <div class="form-group">
      <label for="display_order" class="form-label">Display Order </label>
    ...
    <div class="form-group">
      ...
      <div class="radio-inline">
        <input type="radio" name="status" value="0" class="magic-radio" id="status_0" <?php echo $detail['testimonial_status'] == '0' ?  'checked' : ''; ?>>
        <label for="status_0">Inactive</label>
      </div>
    </div>
