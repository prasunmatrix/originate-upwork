      ...
      <div class="box">
		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				$status = '';
				if($v['experience_level_status'] == ACTIVE_STATUS){
				...
				}else if($v['experience_level_status'] == INACTIVE_STATUS){
				...
				<tr>
                  ...
                  <td><?php echo $v['experience_level_name']; ?></td>
                  <td><?php echo $status; ?></td>
                  <td class="text-right" style="padding-right:20px;">
					<?php if($v['experience_level_status'] != DELETE_STATUS){ ?>
