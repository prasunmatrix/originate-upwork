      ...
      <div class="box">
		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				$status = '';
				if($v['language_preference_status'] == ACTIVE_STATUS){
				...
				}else if($v['language_preference_status'] == INACTIVE_STATUS){
				...
				<tr>
                  ...
                  <td><?php echo $v['language_preference_name']; ?></td>
                  <td><?php echo $status; ?></td>
                  <td class="text-right" style="padding-right:20px;">
					<?php if($v['language_preference_status'] != DELETE_STATUS){ ?>
