    ...
    <section class="content">
      ...
      <!-- Default box -->
		<ul class="nav nav-tabs">
		   <?php if($this->permission_model->checkPermission('MEN0002_EDIT', FALSE)){ ?>
		  <li class="<?php echo $tab == 'general' ? 'active' : '';?>"><a href="<?php echo base_url('setting/general'); ?>">General</a></li>
		  <?php } ?>
		  
		 <?php if($this->permission_model->checkPermission('MEN0003_EDIT', FALSE)){ ?>
		  <li class="<?php echo $tab == 'custom' ? 'active' : '';?>"><a href="<?php echo base_url('setting/custom'); ?>">Custom</a></li>
		  <?php } ?>
		</ul>
      <div class="box">
              ...
              <table class="table table-hover">
				...
				<tr>
                  ...
                  <td class="text-right" style="padding-right:20px;">
					...
					<a href="<?php echo JS_VOID; ?>" onclick="return deleteRecord('<?php echo $v[$primary_key]; ?>', true)"data-toggle="tooltip" title="Delete"><i class="icon-feather-trash red <?php echo ICON_SIZE;?>"></i></a>
					<?php } ?>
