            ...
            <table class="table table-hover">
				...
				<tr>
                  ...
                  <td class="text-right" style="padding-right:15px;">	
					...
					<a href="<?php echo JS_VOID; ?>" onclick="return deleteRecord('<?php echo $v[$primary_key]; ?>', true)" data-toggle="tooltip" title="Delete" data-placement="top"><i class="icon-feather-trash text-danger <?php echo ICON_SIZE;?>"></i></a>
					<?php } ?>
