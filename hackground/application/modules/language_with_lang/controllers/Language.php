...
class Language extends MX_Controller {
   ...
   private $data;
	...
	public function __construct(){
		...
		$this->data['lang_table'] = 'languages_names';
		$this->data['primary_key'] = 'language_id';
	...
	public function list_record(){
		...
		$this->data['add_btn'] = 'Add Language';
	...
	public function add(){
		...
		if(post() && $this->input->is_ajax_request()){
			...
			foreach($lang as $k => $v){
				$this->form_validation->set_rules('lang[language_title]['.$v.']', "name $v", 'required|trim|max_length[100]');
			}
