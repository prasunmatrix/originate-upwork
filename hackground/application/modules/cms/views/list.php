          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="right"><?php if($v['status'] != DELETE_STATUS){ ?>
                ...
                <a href="<?php echo base_url($curr_controller.'addedit/'.$v[$primary_key]);?>" class="mr-1" data-toggle="tooltip" title="Edit"><i class="icon-feather-edit text-success <?php echo ICON_SIZE;?>"></i></a><a href="<?php echo JS_VOID; ?>" onclick="return deleteRecord('<?php echo $v[$primary_key]; ?>')"data-toggle="tooltip" title="Delete"><i class="icon-feather-trash text-danger <?php echo ICON_SIZE;?>"></i></a>
