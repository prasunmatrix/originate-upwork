		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				<tr>
                  ...
                  <th style="width:40%">Transaction Type Key</th>
                  <th style="width:20%">Transaction Type Value</th>  
				...
				<tr>
                  ...
                  <td><?php echo $v['title_tkey']; ?></td>
                  <td><?php echo $v['description_tkey']; ?></td>
                  ...
                  <td class="text-right" style="padding-right:20px;">
						...
						&nbsp;
					<a class="hide" href="<?php echo JS_VOID; ?>" onclick="return deleteRecord('<?php echo $v[$primary_key]; ?>', true)"data-toggle="tooltip" title="Delete Permanently"><i class="icon-feather-trash red <?php echo ICON_SIZE;?>"></i></a>
