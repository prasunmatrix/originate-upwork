              ...
              <table class="table table-hover">
				...
				<tr>
                  ...
                  <td class="text-right" style="padding-right:20px;">
					...
					<a href="<?php echo JS_VOID; ?>" onclick="add_child('<?php echo $v[$primary_key]; ?>')" data-toggle="tooltip" title="Add Child"><i class="icon-feather-plus <?php echo ICON_SIZE;?>"></i></a>
					&nbsp;
					<a href="<?php echo base_url('help_cms/list_record?parent='.$v[$primary_key]); ?>" data-toggle="tooltip" title="View Child"><i class="icon-feather-list <?php echo ICON_SIZE;?>"></i></a>
					&nbsp;
					<?php }else{  ?>
						<a href="<?php echo JS_VOID; ?>" onclick="add_article('<?php echo $v[$primary_key]; ?>')" data-toggle="tooltip" title="Add Article"><i class="icon-feather-plus-circle <?php echo ICON_SIZE;?>"></i></a>
						&nbsp;
						<a href="<?php echo base_url('help_article/list_record/'.$v[$primary_key]); ?>" data-toggle="tooltip" title="View Article"><i class="icon-feather-list <?php echo ICON_SIZE;?>"></i></a>
					&nbsp;
					<?php } ?>
...
function add_article(id){
	var url = '<?php echo base_url('help_article/load_ajax_page?page=add&cms_help_id=');?>'+id;
	load_ajax_modal(url);
}


function add_child(parent){
	var url = '<?php echo base_url($curr_controller.'load_ajax_page?page='.$add_command.'&parent_id=');?>'+parent;
	load_ajax_modal(url);
}

function add(){
	var url = '<?php echo base_url($curr_controller.'load_ajax_page?page='.$add_command.'&parent_id='.$parent_id);?>';
	load_ajax_modal(url);
}
