...
<form role="form" id="add_form" action="<?php echo $action; ?>" onsubmit="submitForm(this, event)">
    ...
    <div class="form-group">
        <label for="experience_level" class="form-label">Select skills</label>
...
<?php if(!empty($detail['member_skills']['all_skills'])){ foreach($detail['member_skills']['all_skills'] as $skill){ ?>
