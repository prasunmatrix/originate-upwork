...
function manage_component(id){
	var url = '<?php echo base_url('component/load_ajax_page?page=add_category_component&category_level=4&category_subchild_id=');?>'+id;
	load_ajax_modal(url);
}

function add(){
	var url = '<?php echo base_url($curr_controller.'load_ajax_page?page='.$add_command.'&category_subchild_level_3_id='.$category_id);?>';
	load_ajax_modal(url);
}
