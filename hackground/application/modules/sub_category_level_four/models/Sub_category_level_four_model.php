...
class Sub_category_level_four_model extends CI_Model{
	...
	public function getList($srch=array(), $limit=0, $offset=20, $for_list=TRUE){
		...
		if(!empty($srch['category'])){
			$this->db->where('a.category_subchild_level_3_id', $srch['category']);	
	...
	public function addRecord($data=array()){
		$structure = array(
			...
			'category_subchild_level_3_id' => !empty($data['category_subchild_level_3_id']) ? $data['category_subchild_level_3_id'] : '',
	...
	public function get_category_name($category_subchild_level_4_id=''){
		$admin_default_lang = admin_default_lang();
		$this->db->select('*')
			->from('category_subchild_level_4 a')
			->join('category_subchild_level_4_names b', 'a.category_subchild_level_4_id=b.category_subchild_level_4_id');
			
		$this->db->where('b.category_subchild_lang', $admin_default_lang);	
		$this->db->where('a.category_subchild_level_4_id', $category_subchild_level_4_id);	
