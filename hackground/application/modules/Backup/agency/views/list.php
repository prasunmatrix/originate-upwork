      ...
      <div class="box">
		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				$status = '';
				if($v['agent_status'] == ACTIVE_STATUS){
				...
				}else if($v['agent_status'] == INACTIVE_STATUS){
				...
				<tr>
                  ...
                  <td class="text-right" style="padding-right:20px;">
					<?php if($v['agent_status'] != DELETE_STATUS){ ?>
					...
					&nbsp;
					<a href="<?php echo base_url('broker/list_record?agent_id='.$v[$primary_key]); ?>" data-toggle="tooltip" title="Broker List"><i class="fa fa-list blue <?php echo ICON_SIZE;?>"></i></a>
					&nbsp;
