      ...
      <div class="box">
		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				$status = '';
				if($v['company_status'] == ACTIVE_STATUS){
				...
				}else if($v['company_status'] == INACTIVE_STATUS){
				...
				<tr>
                  ...
                  <td><?php echo $v['company_trade_license']; ?></td>
                  <td><a target="_blank" href="<?php echo base_url('member/list_record?member_id='.$v['member_id']); ?>"><?php echo $v['member_name']; ?></a></td>
                  <td><?php echo date('d M,Y h:i A', strtotime($v['company_reg_date'])); ?></td>
                  <td><?php echo $status; ?></td>
                  <td class="text-right" style="padding-right:20px;">
					<?php if($v['company_status'] != DELETE_STATUS){ ?>
