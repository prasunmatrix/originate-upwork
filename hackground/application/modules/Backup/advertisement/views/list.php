<!-- Select2 -->
<link rel="stylesheet" href="<?php echo ADMIN_COMPONENT;?>select2/dist/css/select2.min.css">
<script src="<?php echo ADMIN_COMPONENT;?>select2/dist/js/select2.full.min.js"></script>
<!-- Overwriting with theme design -->
		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				<tr>
                  ...
                  <td><?php echo $this->advertisement->get_page_name($v['page']); ?></td>
                  <td><?php echo $v['position']; ?></td>
                  <td><?php echo ucwords($v['ad_type']); ?></td>
