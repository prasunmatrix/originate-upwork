		...
		<div class="box-body table-responsive no-padding" id="main_table">
              <table class="table table-hover">
				...
				<tr>
                  ...
                  <th style="width:15%">Deed Number</th>
				...
				$status = '';
				if($v['landlord_status'] == ACTIVE_STATUS){
				...
				}else if($v['landlord_status'] == INACTIVE_STATUS){
				...
				<tr>
                  ...
                  <td><?php echo $v['landlord_name']; ?></td>
                  <td><?php echo $v['deed_number']; ?></td>
				   <td><a target="_blank" href="<?php echo base_url('member/list_record?member_id='.$v['member_id']); ?>"><?php echo $v['member_name']; ?></a></td>
                  <td><?php echo date('d M,Y h:i A', strtotime($v['reg_date'])); ?></td>
                  <td><?php echo $status; ?></td>
                  <td class="text-right" style="padding-right:20px;">
					<?php if($v['landlord_status'] != DELETE_STATUS){ ?>
